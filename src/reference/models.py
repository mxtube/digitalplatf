...
class Status(models.Model):
    ...
    # TODO: Добавить поле цвет, для окрашивания строк в таблице "Справки". Можно использовать библиотеку
...
class Reference(models.Model):
    ...
    user = models.ForeignKey(CustomPerson, on_delete=models.PROTECT, verbose_name='Заявитель',
                             related_name='reference_user_to_customperson_id_fkey')
    type = models.ForeignKey(Type, on_delete=models.PROTECT, verbose_name='Тип справки',
                             related_name='reference_type_to_type_id_fkey')
    ...
    status = models.ForeignKey(Status, on_delete=models.PROTECT, default=1, verbose_name='Статус',
                               related_name='reference_status_to_status_id_fkey')
...
class ReferenceNotify(models.Model):
    ...
    department = models.ForeignKey(Department, on_delete=models.PROTECT, verbose_name='Площадка',
